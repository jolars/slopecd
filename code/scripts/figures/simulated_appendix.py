...
results_dir = here("results/simulated")

cmap = plt.get_cmap("tab10")

# Simulated setting 1
bench_name = results_dir / "Simulated1.parquet"
df = pd.read_parquet(results_dir / bench_name, engine="pyarrow")
...
fig, axarr = plt.subplots(
    ...
    sharex=False,
    sharey="row",
    figsize=[plot_utils.FULL_WIDTH, plot_utils.FULL_WIDTH * 0.6],
...
if save_fig:
    figpath = plot_utils.fig_path("simulated_appendix.pdf")
    legendpath = plot_utils.fig_path("simulated_legend_appendix.pdf")
