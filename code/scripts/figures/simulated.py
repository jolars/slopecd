...
fig, axarr = plt.subplots(
    ...
    sharex=False,
    sharey="row",
    figsize=[plot_utils.FULL_WIDTH, plot_utils.FULL_WIDTH * 0.55],
...
if save_fig:
    figpath = plot_utils.fig_path("simulated.pdf")
    legendpath = plot_utils.fig_path("simulated_legend.pdf")

    fig.savefig(figpath, bbox_inches="tight", pad_inches=0.05)
    plot_utils.plot_legend_apart(axarr[0, 0], legendpath, ncol=4)
else:
