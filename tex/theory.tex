...
\begin{remark}
  \(T_k\) is a unique minimizer in this case because \(G\) is the sum of a quadratic function in one variable and a norm.
  For other objectives, such as sorted \(\ell_1\)-regularized logistic regression, \(T_k\) would not be a unique minimizer in general.
\end{remark}
