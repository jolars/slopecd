...
using the HPC facilities of the University of Luxembourg~\parencite{Varette2022}
(see \texttt{\href{http://hpc.uni.lu}{hpc.uni.lu}})

\jl{Should some of this go in the Appendix instead?}
...
For the second scenario, notice that all solvers take considerably longer than the hybrid method to reach convergence.
