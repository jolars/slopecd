...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{block}{\textbf{\color{malgared}{\#1 Clusterwise minimization}}}
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{images/slope-thresholding}
		\end{center}
		\end{block}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{block}{\textbf{\color{malgared}{\#2 Cluster identification}}}
		%
		{\textbf{\color{malgared}{Property}}}: If $\lambda$ is a strictly decreasing sequence, the sorted $\ell_1$ norm is \textbf{partly smooth} and so Proximal Gradient identifies the clusters of the solution in a finite number of steps.
	\end{block}
