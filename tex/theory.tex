...
\begin{algorithm}[h!]
  ...
  \If{\(t \bmod v = 0\)}{
    \(\beta \leftarrow \prox_{J}(\beta - \frac{1}{\norm{X}_2^2}X^\top(X \beta - y); \lambda / \norm{X}_2^2)\) \label{alg:hybrid-istastep}
...
\begin{lemma}
  ...
  \[
    P(\beta^{(k)}) - P(\beta^*) \leq \frac{\Vert X \Vert_2^2 \lVert \beta^{(0)} - \beta^* \rVert^2}{2\lfloor k/v \rfloor }\, ,
  \]
