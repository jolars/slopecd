...
Finally, we re-ran the experiment from the introduction on the \dataset{bcTCGA} dataset that took 43 seconds for the R package \pkg{SLOPE} to reach convergence on.
Our algorithm, which, unlike \pkg{SLOPE}, does not use any screening rules, manages to reach convergence in 2.91 seconds.
