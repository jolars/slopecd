...
\begin{theorem}[The SLOPE Thresholding Operator]
  ...
  \[
    ...
    \begin{cases}
      ...
      \sign(\theta)c_i                                                                                                                            & \text{if } \omega c_i + \smashoperator{\sum_{j \in C(c_i - \varepsilon)}} \lambda_{(j)^-_{c_i - \varepsilon}} \leq |\gamma| \leq \omega c_i + \smashoperator{\sum_{j \in C(c_i + \varepsilon)}} \lambda_{(j)^-_{c_i + \varepsilon}}, \\
...
\end{theorem}
\begin{proof}
  Recall that \(J_k(z) : \mathbb{R} \mapsto \mathbb{R}\) is a convex, piecewise
  continuous function with discontinuities whenever \(z \in \{0, c_i\}\), \(i
  \neq k\). Let \(\gamma =
