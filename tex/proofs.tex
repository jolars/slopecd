...
Now we are ready prove the statements:
\begin{enumerate}
...
\begin{enumerate}
  ...
  \klopfe{Prove that the inequality constraint in the case not 0 belongs to the hyperplane defined by the equality constraints}
\begin{itemize}
