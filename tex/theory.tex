...
\jl{Is this reasoning sound? The PGD step does not immediately identify clusters.}
...
In the sequel, $\beta$ is fixed, with $m$ clusters $\mathcal{C}_1, \ldots, \mathcal{C}_m$ corresponding to values $c_1, \ldots, c_m$.
