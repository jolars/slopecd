...
ordering patterns in the solution~\parencite{bogdan2022}.
Contrary to other coefficient clustering approaches such as the fused Lasso~\parencite{tibshirani2005sparsity}, it is
independent of feature order, and in addition does not require prior knowledge of the number of clusters.
Finally, unlike other competing sparse regularization methods such as MCP~\parencite{zhang2010} and
...
require the non-smooth part of the objective to be coordinate-wise separable, which is not the case for SLOPE. As a
