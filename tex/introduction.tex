...
As a small illustration of this issue, we compared the speed at which the SLOPE and glmnet packages solve a SLOPE and lasso problem, respectively, for the bcTCGA data set.
In this small experiment, the SLOPE package takes 42.7 seconds to reach convergence, whilst glmnet requires only 0.143 seconds\footnote{See~\Cref{sec:slope-vs-glmnet} for details on how this experiment was run.}.
