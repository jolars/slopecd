...
To circumvent this issue, we combine these coordinate descent steps with full proximal gradient steps, which enable the algorithm to identify the cluster structure due to the partial smoothness property of the sorted \(\ell_1\) norm~(\Cref{app:sec:partly_smooth}).
