...
Among numerous regression methods, the lasso is the most famous estimator allowing to perform feature selection. %due to its sparsity.  %solution induced by the $\ell_1$ penalty.
