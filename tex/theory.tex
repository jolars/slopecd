...
\begin{remark}
  ...
  \mm{I'd remove the last sentence above, because it's 1) somehow downplaying our results 2) not so clear (logreg is stricly convex so min is unique? 3) for logreg you'd majorize it by a parabola, as for CD? hence the update would be unique still}
\end{remark}
...
\jl{We should probably add a paragraph here about alternative datafits.}
